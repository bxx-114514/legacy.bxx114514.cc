...
## 通过邮件或发表在 [留言板](https://legacy.bxx114514.cc/comments.html)

- 将所需留档的图文发邮箱到 tzhong072@gmail.com 或 bxx-114514@outlook.com。
- 直接发表在 [留言板](https://legacy.bxx114514.cc/comments.html)。注意带图 **需要自备图床**。
...
单击 [Fork](https://github.com/bxx-114514/legacy.bxx114514.cc/fork) 或者进入 [仓库](https://github.com/bxx-114514/legacy.bxx114514.cc) 单击 Fork 按钮，Fork 一份在你的 GitHub 账户中。
...
1. 先打开你所需的工作区文件夹，注意路径中 **不能** 有中文、日文、韩文、emoji 等非半角英文字符和半／全角空格！
...
> - 例如 `git clone https://github.com/your-username/legacy.bxx114514.cc example` 是指定克隆到工作目录下的 `example` 文件夹。
> - 而 `git clone https://github.com/your-username/legacy.bxx114514.cc example/abc` 则是指定克隆到工作目录下 `example` 里的 `abc` 文件夹。
...
进入 GitHub，找到你 Fork 的 `your-username/legacy.bxx114514.cc` 仓库。  
